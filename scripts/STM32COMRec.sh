...
normal_pass() {
       ...
       "resource/STM32COMRecev/.pio/build/genericSTM32F103RB/firmware.elf" \
       firmware.elf \
       ${DownloadSite} \
       ${Branch} \
       "/opt/workspace/stm32f103rbt6-fw_usart_hello/.pio/build/genericSTM32F103RB/firmware.elf"

       source /tmp/download.sh \
       "resource/STM32COMRecev/Core/Src/main.c" \
       main.c \
       ${DownloadSite} \
       ${Branch} \
       "/opt/workspace/stm32f103rbt6-fw_usart_hello/Core/Src/main.c"
