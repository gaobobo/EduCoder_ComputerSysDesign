...
normal_pass() {
       ...
       "resource/STM32ADTrans/.pio/build/genericSTM32F103RB/firmware.elf" \
       firmware.elf \
       ${DownloadSite} \
       ${Branch} \
       "/opt/workspace/stm32f103rbt6-fw_res_adc/.pio/build/genericSTM32F103RB/firmware.elf"

       source /tmp/download.sh \
       "resource/STM32ADTrans/Core/Src/main.c" \
       main.c \
       ${DownloadSite} \
       ${Branch} \
       "/opt/workspace/stm32f103rbt6-fw_res_adc/Core/Src/main.c"
