...
normal_pass() {
       ...
       "resource/STM32Buzzr/.pio/build/genericSTM32F103RB/firmware.elf" \
       firmware.elf \
       ${DownloadSite} \
       ${Branch} \
       "/opt/workspace/stm32f103rbt6-fw_buzzer/.pio/build/genericSTM32F103RB/firmware.elf"

       source /tmp/download.sh \
       "resource/STM32Buzzr/Core/Src/main.c" \
       main.c \
       ${DownloadSite} \
       ${Branch} \
       "/opt/workspace/stm32f103rbt6-fw_buzzer/Core/Src/main.c"
